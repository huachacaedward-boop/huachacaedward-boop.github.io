      ...
      <section className="relative overflow-hidden px-4 sm:px-8 py-10 sm:py-16 border-b border-white/10 bg-gradient-to-b from-amber-500/5 via-transparent to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-amber-500/10 border border-amber-500/30 text-amber-300 text-[11px] font-mono-tech uppercase tracking-widest mb-4">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Plataforma de Presentación Arquitectónica HD</span>
            </div>
            ...
            <p className="text-sm sm:text-base text-stone-300 mt-4 max-w-2xl leading-relaxed">
              Visualiza tus proyectos de arquitectura, renders y planos en un visor de alta fidelidad con paso de página físico.
              Haz clic sobre cualquier render para ampliarlo en pantalla completa con soporte de hasta <strong>500 MB</strong> y <strong>100 páginas</strong>.
            </p>
