      ...
      >
        ...
        <div className="mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-300 text-xs font-semibold mb-2">
            ...
            <span>Publicador Ultra HD</span>
          </div>
          <h2 className="text-xl sm:text-2xl font-extrabold tracking-tight text-white">
            Publicar Portafolio en Libro Interactivo
          </h2>
          <p className="text-xs sm:text-sm text-white/60 mt-1">
            Convierte tu PDF en un libro digital 3D de alta fidelidad, con paso de página realista y navegación táctil.
          </p>
        </div>

        {/* Requirements Pill Grid */}
        <div className="grid grid-cols-3 gap-2.5 mb-6 p-3 rounded-2xl bg-black/40 border border-white/10 text-center">
